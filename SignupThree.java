...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree(String formno){
        ...
        JLabel number = new JLabel ("xxxx-xxxx-xxxx-1733");
        ...
        c7=new JCheckBox("I herby Declare that above enter details are correct to the best of my knowledge");
        c7.setBackground(Color.WHITE);
        c7.setFont (new Font ("Raleway",Font.BOLD,12));
        c7.setBounds(100,680,680,30);
        add(c7);
            ...
            try{
                if(accountType.equals("")){
                   ...
                   String query2 ="insert into login values('"+formno +"','"+cardnumber +"','"+pinnumber +"')";
                    ...
                    setVisible(false);
                    new Transaction(pinnumber).setVisible(true);  // Open the Transaction window
